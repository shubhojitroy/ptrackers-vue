...
export default {
  data() {
    const offerEvents = [
        ...
        { description: 'General Public Offer Opens', date: 'Tuesday 10 July 2018' },
        { description: 'General Public Offer Closes', date: 'Friday 10 August 2018' },
        { description: 'Broker Firm Offer Opens ', date: 'Tuesday 10 July 2018' },
